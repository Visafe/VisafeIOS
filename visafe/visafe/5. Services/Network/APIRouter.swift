...
extension APIRouter: TargetType {
    ...
    var method: Moya.Method {
        ...
        case .getListWorkspace, .profile, .getGroups, .listNotification,
             ...
             .logGroup, .logWorkspace, .genDeviceId, .getGroup:
            return .get
