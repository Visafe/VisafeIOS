...
class WorkspaceWorker {
    ...
    static func add(workspace: WorkspaceModel, completion: @escaping (_ result: BaseResult?, _ error: Error?) -> Void) {
    ...
    static func update(workspace: WorkspaceModel, completion: @escaping (_ result: BaseResult?, _ error: Error?) -> Void) {
