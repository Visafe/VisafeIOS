...
//			self.placeholderLabel.font = self.placeholderLabel.font.withSize(self.originalPlaceholderFontSize)
	...
	private func addPlaceholderLabelIfNeeded() {
		...
		NSLayoutConstraint.activate([
            placeholderLabel.leadingAnchor.constraint(equalTo: leadingAnchor, constant: leftPadding),
            placeholderLabel.trailingAnchor.constraint(equalTo: trailingAnchor, constant: rightPadding)
			])

		addLayoutGuide(placeholderLayoutGuide)

		NSLayoutConstraint.activate([
            placeholderLayoutGuide.leadingAnchor.constraint(equalTo: leadingAnchor, constant: leftPadding),
            placeholderLayoutGuide.trailingAnchor.constraint(equalTo: trailingAnchor, constant: rightPadding),
