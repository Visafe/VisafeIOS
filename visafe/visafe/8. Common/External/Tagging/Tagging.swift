...
//            dataSource?.tagging(self, didChangedTagableList: matchedTagableList)
            dataSource?.tagging(self, didChangedMentionText: currentTaggingText)
        }
    }
    ...
    public func updateTaggedList(allText: String, tagText: String,object:Any? = nil) {
        ...
        taggedList.append(TaggingModel(text: tagText, range: tagRange,object: object))
...
extension Tagging {
    ...
    private func layout() {
        ...
        addConstraints(
            [NSLayoutConstraint(item: placeHolderLabel, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1.0, constant: 20),
             NSLayoutConstraint(item: placeHolderLabel, attribute: .top, relatedBy: .equal, toItem: self, attribute: .top, multiplier: 1.0, constant: 15),
             NSLayoutConstraint(item: placeHolderLabel, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1.0, constant: 0)])
    }
...
extension Tagging: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        ...
        placeHolderLabel.isHidden = textView.text.length != 0
        dataSource?.tagging(self, didChangedText: textView.text.trim())
    }
