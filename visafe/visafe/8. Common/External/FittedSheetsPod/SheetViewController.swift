...
public class SheetViewController: UIViewController {
    ...
    public var topEdgeInset: CGFloat = 20
    ...
    private func setUpContainerView() {
        self.view.addSubview(self.containerView) { (subview) in
            ...
            subview.top.pinToSuperview(inset: topEdgeInset == 0 ? 0 : self.safeAreaInsets.top + topEdgeInset, relation: .greaterThanOrEqual)
...
class HiddenNavigationSheetViewController: SheetViewController {
...
extension UIViewController{
    func presentHiddenNavigationSheetViewController(_ viewController: UIViewController) {
        let sizes = [SheetSize.fullScreen]
        let controller = viewController
        viewController.view.backgroundColor = UIColor.clear
        let sheetController = HiddenNavigationSheetViewController(controller: controller, sizes: sizes)
        sheetController.adjustForBottomSafeArea = true
        sheetController.blurBottomSafeArea = true
        sheetController.dismissOnBackgroundTap = true
        sheetController.extendBackgroundBehindHandle = true
        sheetController.topCornersRadius = 15
        sheetController.overlayColor = AppColor.lightBlue
        ...
        self.present(BaseNavigationController(rootViewController: sheetController), animated: false, completion: nil)
    }
}
