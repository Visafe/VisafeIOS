...
class SupportTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case (optionsSection, faqRow):
            UIApplication.shared.openVisafeUrl(action: "faq", from: "support", buildVersion: productInfo.buildVersion())
        ...
        case (optionsSection, discussRow):
            UIApplication.shared.openVisafeUrl(action: "discuss", from: "support", buildVersion: productInfo.buildVersion())
